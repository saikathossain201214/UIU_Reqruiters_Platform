        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="admin_teacher" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Teacher</a>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-6">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <form action="teacher_data_insert" method="POST" autocomplete="off">
                                @csrf
                    ...
                    <div class="col-sm-12 ">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table table-dark">
                               ...
                               <!-- php code as table for fatche the tecaher data -->
                            </table>
