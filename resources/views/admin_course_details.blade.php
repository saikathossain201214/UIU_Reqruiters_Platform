        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="admin_dashborad" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="admin_grdaer_request" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Gradder Request</a>
...
<table  style="width:100%">
  ...
  <tr>
    ...
    <td><a href=''><button>DELET</button></a></td>
