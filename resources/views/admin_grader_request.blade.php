...
<body>
   ...
   <br>
   <h1 style=" text-align: center">Grader Request</h1>
   <hr><hr>
   <br>
  ...
  <div class='row'>
    ...
    <div class='col-sm'>
     <div>
         <!-- <p>Name : Saikat Hossain</p>
         <p>Id : 011201214</p>
         <p>CGPA : 4.00</p>
         <p>Current UA : Database Management System (A) </p>
        <a href='view_profile.php> <button type='button' class='btn btn-primary'>View Profile</button></a>
         <a href='taaddapi.php?name=$name&&id=$id&&cname=$cname&&cid=$cid&&section=$section&&tid=$zid&&cr=$cr'><button type='button' class='btn btn-success'>Add</button></a> -->
...
<table class="table table-striped">
  ...
  <tbody>
  @foreach($grader_apply_data as $gad)
            <tr>
                ...
                <td>{{$gad->cid}}</td>
                <td>{{$gad->section}}</td>
                <td> <a href='/deletebtn/{{$gad->id}}'><button type='button' class='btn btn-danger'>Delete</button></a></td>
                <td> <a href='/deletebtn/{{$gad->id}}'><button type='button' class='btn btn-danger'>View Profile</button></a></td>
                <td>
          <!-- Form to update situation column -->
                   <form action="{{ route('update.situationgrader', ['id' => $gad->id]) }}" method="POST">
                      @csrf
