            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        ...
                        <form action="research" method="POST" class="searchform order-lg-last">
...
<body>
    <h1><u>Research Interest</u></h1> 
    <br>
    <hr>
    <ul>
        
    <!-- <li class="li">Machine learning</li>
    <li class="li">Application of Machine Learning in Bio Informatics</li>
    <li class="li">Data Analytics</li>
    <li class="li">Natural Language Processing</li> -->
    </ul>
    <br>
    <br>
    <br>
  ...
  <form action="researchPost" method="POST">
     @csrf
    <h4>Added: </h4>
    <textarea name="topic" id="text" cols="100" rows="5" ></textarea>
    <br>
   ...
   <!-- <textarea class="form-control" rows="5"   id="comment" name="text" style="background-color='red'"></textarea>
    <br>
    <button type="submit" class="btn btn-primary">Submit</button> -->
...
</p></div><div id="tab_4_title" class="tab-pane"><p><ul>
