...
<tbody>
    ...
    <tr>
      ...
      <td></td>
      <td> <a href='/applyGbtn/{{$course->id}}'><button type='button' class='btn btn-primary'>Apply</button></a></td>
    </tr> 
   @endforeach
      ...
      <th scope="col">Section</th>
        ...
        @foreach($apply as $applys)
            <tr>
                ...
                <td> <a href='/deleteGbtn/{{$applys->id}}'><button type='button' class='btn btn-danger'>Delete</button></a></td>
            </tr>
              @endforeach
