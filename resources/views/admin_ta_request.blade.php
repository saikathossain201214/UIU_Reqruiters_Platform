...
<body>
   ...
   <h1 style=" text-align: center">Teacher Assistant Request</h1>
   <hr><hr>
   <br>
...
<div class='container'>
  ...
  <div class='row'>
    ...
    <div class='col-sm'>
     <div>
         <!-- <p>Name : Nazmul Hoda</p>
         <p>Id : 011201224</p>
         <p>CGPA : 2.50</p>
         <p>Current UA : Database Management Systems Laboratory(B) </p>
  ...
  <tbody>
         @foreach($ta_apply_data as $tad)
          ...
          <!-- Form to update situation column -->
                   <form action="{{ route('update.situationta', ['id' => $tad->id]) }}" method="POST">
                      @csrf
